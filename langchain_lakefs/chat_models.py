...
class ChatLakeFS(BaseChatModel):
    ...
    Key init args — client params:
        ...
        api_key: Optional[str]
            LakeFS API key. If not passed in will be read from env var LAKEFS_API_KEY.
    ...
    Tool calling:
        ...
        See ``ChatLakeFS.bind_tools()`` method for more.
    ...
    Structured output:
        ...
        See ``ChatLakeFS.with_structured_output()`` for more.
    ...
    # TODO: Implement if ChatLakeFS supports async streaming. Otherwise delete.
    # async def _astream(
    #     self,
    #     messages: List[BaseMessage],
    #     stop: Optional[List[str]] = None,
    ...
    # TODO: Implement if ChatLakeFS supports async generation. Otherwise delete.
